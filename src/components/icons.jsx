// Minimal inline icon set (stroke-based, currentColor) — no external icon deps.
const base = {
  width: 18,
  height: 18,
  viewBox: '0 0 24 24',
...
export function InvoicesIcon(props) {
  return (
    <svg {...base} {...props}>
...
export function CashFlowIcon(props) {
  return (
    <svg {...base} {...props}>
...
/* ---------- KPI icons ---------- */
export function OutstandingIcon(props) {
  return (
    <svg {...base} {...props}>
...
export function RemindersIcon(props) {
  return (
    <svg {...base} {...props}>
